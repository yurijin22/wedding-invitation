    ...
    <section className="py-24 px-8 bg-white">
      ...
      >
        <div className="text-center space-y-4">
          <p className="font-script text-3xl text-[#141414] italic">Save the date</p>
        ...
        <div className="text-center space-y-1">
          <p className="text-sm tracking-widest text-[#261E1A]">{wedding.time}</p>
          <p className="text-xs text-[#6B7870] font-sans font-light">
