  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontFamily: "'Pretendard Variable', Pretendard, sans-serif", fontSize: 12.5, lineHeight: "20px", letterSpacing: "0.01em", color: "#8B8178", margin: "6px 0 clamp(34px, calc(4svh + 14px), 54px)" }}>
