...
const MAIN_ADJUST: Record<number, { pos?: string; scale?: number }> = {
  ...
  6: { pos: "50% 68%" },              // 살짝 위로
  7: { pos: "50% 82%", scale: 1.32 }, // 커플이 아래·위 대나무 많음 → 확대+아래프레이밍
  8: { pos: "50% 80%", scale: 1.28 }, // 동일 패턴
  10: { pos: "50% 68%" },             // 살짝 위로
  11: { pos: "50% 68%" },             // 살짝 위로
  12: { pos: "50% 32%" },             // 살짝 아래로(위 치우침)
  13: { pos: "50% 68%" },             // 살짝 위로
  14: { pos: "50% 85%", scale: 1.35 }, // 3:4 계단샷, 커플 아래·위 흰벽 → 확대+아래
  15: { pos: "50% 68%" },             // 살짝 위로
  17: { pos: "50% 72%", scale: 1.25 }, // 스튜디오 상반신, 위 여백 → 확대+아래
  21: { pos: "50% 32%" },             // 살짝 아래로(위 치우침)
  23: { pos: "50% 68%" },             // 살짝 위로
  25: { pos: "8% 50%", scale: 1.22 }, // 오른쪽 벽돌 가리게 왼쪽으로 + 확대
  29: { pos: "50% 90%", scale: 1.45 }, // 와이드샷, 커플 아래 1/3 → 확대 크게+아래
};
